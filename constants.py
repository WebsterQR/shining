...
class TextTemplates:
    ...
    message_before_auth = ("Привет, сияющий✨\n\n"
                           ...
                           "Данный бот нужен для того, чтобы ты вовремя узнавал обо всех играх и встречах Сияющих, "
                           "будь то кино, путешествие или что-то ещё 🔥\n\n"
    ...
    message_team_promo = (f"📌 Презентация Сияния:\n"
                          ...
                          "Тут вся информация о нас собрана в одном месте: здесь и ссылка на таблицу, "
                          "и на альманах, и вообще лучше подземелья")
    ...
    message_useful_links = (f"📌 Таблица всея команды:\n[Тык сюда]({Links.team_table})\n\n"
                            ...
                            fr"❓Есть вопрос, идеи для улучшения команды \- пиши @Narp13 или "
                            f"@KatherinaPolezhaeva")  # flake8: noqa: W605
    ...
    notifications_disabled = ("Очень жаль, но этому явно есть причина. Мы все понимаем 🙏\n\n"
                              "Напомним, что меню для тебя все еще активно, а также есть функция "
                              "'Включить рассылку о мероприятиях' в меню бота\n\n"
                              " До встречи 👋")
    ...
    participate_yes = "Ура\! Информация добавлена"
    participate_no = "Очень жаль, возможно в другой раз ты с нами"